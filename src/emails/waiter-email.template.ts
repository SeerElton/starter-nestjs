export function waiterEmailTemplate(host, name, email, connectSmartWatch) {
    ...
    <style>
        * {
        ...
        body {
            margin: 0;
            padding: 0;
            background-image: url('${imagesUrl}/et-img2.JPG');
                                                                    ...
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:16px;">We have
                                                                                successfully created your serve.6 waiter
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center" class="alignment">
                                                                    <p
                                                                        style="font-size: 14px; mso-line-height-alt: 21px; color: #393d47; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                                        To connect a device / smart watch. </p>
                                                                    <a href="${connectSmartWatch}" style="text-decoration: none; display: inline-block;
    color: #ffffff;
...
" target="_blank"><span style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                    style="word-break: break-word; line-height: 24px;">Connect Smart Watch</span></span></a>
                                                                    <br>
                                                                    <br>
                                                                    <span
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-10"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #26a9e099; margin-top: 30px;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
