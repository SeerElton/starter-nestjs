export function forgotPasswordEmailTemplate(host, name, email, forgotPasswordUrl) {
    ...
    <style>
        * {
        ...
        body {
            margin: 0;
            padding: 0;
            background-image: url('${imagesUrl}/logo.png');
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:16px;">We are sorry you forgot your password.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div align="center" class="alignment">
                                                                    ...
                                                                    <a href="${forgotPasswordUrl}" style="text-decoration: none; display: inline-block;
    color: #ffffff;
