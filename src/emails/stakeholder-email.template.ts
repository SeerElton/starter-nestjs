export function stakeholderEmailTemplate(host, name, email, resetPasswordUrl) {
                                                                    ...
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:16px;">We have
                                                                                successfully created your serve.6
...
" target="_blank"><span style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break: break-word; line-height: 24px;">Reset
